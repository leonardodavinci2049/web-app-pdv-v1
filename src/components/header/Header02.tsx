...
export default function Header02() {
  return (
    <header className="sticky top-5 z-50 flex justify-center container mx-auto px-4 md:px-0">
      <div className="min-w-full border rounded-md  w-full bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 py-1 px-4">
